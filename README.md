...
# 快速使用：[https://www.bilibili.com/video/BV1mjVS6QEjT](https://www.bilibili.com/video/BV1mjVS6QEjT/)

## 不建议使用打包的setup，我没有测试，建议调试环境启动
...
**我把submit和main分支同步了，都是最新的目前，不过不是通过pr提交**
...
# 下一阶段（b站视频中未展示，时间原因，目前开发不完善）

**enhance**分支，支持从图片中提取日程，这在PC端，比语音输入更常用，比打字输入更快捷，优化了操作界面，更加完善人性化得交互体验
